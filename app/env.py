...
class AutoscalerEnv:
    ...
    def __init__(self):
        ...
        # Multi-Agent Message Bus: Stores the 'beliefs' and 'forecasts' 
        # generated by sub-agents to pass to the Planner.
        self.communication_buffer: Dict[str, Any] = {
            "scientist_report": "No data yet.",
            "oracle_forecast":  "No data yet.",
            "planner_notes":    "No data yet."
        }
    ...
    def step(self, action: AutoscalerAction) -> StepResult:
        ...
        info = {
            "step":           raw["current_step"],
            "capacity":       raw["capacity"],
            "latency":        raw["latency"],
            "overflow":       raw["overflow"],
            "instability":    raw["instability"],
            "db_load_factor": raw["db_load_factor"],
            "reward":         reward,
        ...
        result = StepResult(
            ...
            info={**info, "communication": self.communication_buffer},
        )
    ...
    def update_communication(self, role: str, message: Any):
        """
        Update the shared message bus for the multi-agent pipeline.
        Role must be one of: scientist_report, oracle_forecast, planner_notes.
        """
        if role not in self.communication_buffer:
            raise ValueError(f"Unknown agent role: {role}")
        self.communication_buffer[role] = message
    ...
    def _obs_from_raw(self, raw: Dict[str, Any]) -> AutoscalerObservation:
        ...
        return AutoscalerObservation(
            ...
            demand_history=raw["demand_history"],
            active_servers=raw["active_servers"],
            booting_queue=raw["booting_queue"],
